...
const TemplatesModalLazy = ReactLazy.lazy(() =>
...
export const Sidebar: React.FC = () => {
  ...
  const [templatesOpenForWs, setTemplatesOpenForWs] = useState<string | null>(
    null,
  );
  ...
  return (
    <div className="w-64 bg-zinc-900 border-r border-zinc-800 flex flex-col h-full flex-shrink-0">
      ...
      {templatesOpenForWs && (
        <ReactLazy.Suspense
          fallback={<div className="p-2 text-xs text-zinc-400">Загрузка…</div>}
        >
          <TemplatesModalLazy
